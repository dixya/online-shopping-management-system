<?php
 ...
 require_once('../auth.php');
	...
	$paypal_id='meetmedixya@ymail.com';  // sriniv_1293527277_biz@inbox.com
?>
<html>
<head>
...
<div id="wrapper">
	...
	<?php if(isset($_GET['pid']))
			...
			<p class="tree"><a href="../index.php?page=category&catid=<?php echo $data2['cat_id']; ?>"><?php echo $data2['cat_name']; ?></a>>  
    		<a href="../index.php?page=subcategory&subcatid=<?php echo $data1['subcat_id']; ?>"><?php echo $data1['subcat_name']; ?></a>> 
    		<?php echo $name;?></p>
	<div id="content">
		<div id="productlist">
			...
			<div class="product-desc">
				<img src="../images/divide.png" width="100%" height="5px">
				<h2 ><img src="../images/horz-divider.png"><?php echo $name;?><img src="../images/horz-divider.png"></h2>


					<?php echo '<a rel="facebox1" href="orderpage.php?pid='.$row['product_id'].'&trnasnum='.$transnum.'"><img src="../images/addcart.png" alt="'.htmlspecialchars($row['product_name']).'" width="200" height="70" class="pngfix" /></a>';?>
					<?php echo '<a href="#"><img src="../images/addtocart-green.png" alt="" width="200" height="70" /></a>';?>
					<h3>PRODUCT DETAILS:</h3>
					<p style="font-size: 20px;"><?php<?php echo $desc;?></p>
					<table cellpadding="10px" cellspacing="10px" width="100%" border="1" >
						<tr>
							<td width="25"><div align="center">Brand</td><td><?php echo $price;?></td><td width="25"><div align="center">Brand</td><td><?php echo $price;?></td>
						</tr>
						<tr>
							<td width="25"><div align="center">Brand</td><td><?php echo $price;?></td><td width="25"><div align="center">Brand</td><td><?php echo $price;?></td>
						</tr><tr>
    ...
    <form name="comment" action="addcomment.php" method="post">
        ...
        <textarea class="the-new-com" name="the-new-com"></textarea>Post comment
    ...
    <div class="clear"></div>
		...
		<div id="orderlist">
			...
			<?php $result5 = mysql_query("SELECT sum(qty) FROM orders WHERE confirmation='$transnum'");
				while($row5 = mysql_fetch_array($result5)){ 
				echo $row5['sum(qty)'];}?>
				" />
			...
			<div class="similar">
				   <?php    $sql_sim = "SELECT * FROM product WHERE subcat_id=$subid and product_id<>$pid ORDER BY product_id LIMIT 5";
					...
					<table cellspacing="5" cellpadding="5">	
						<tr>
							<td><a href="index.php?pid=<?php echo $sim_id; ?>" class="name"><img src="../userfiles/catimages/productimg/<?php echo $data_sim['product_top']; ?>" alt="" width="154" height="90" /></a></td> &nbsp;&nbsp;&nbsp;&nbsp;
					   ...
					   <?php echo '<a rel="facebox" href="orderpage.php?pid='.$sim_id.'&trnasnum='.$transnum.'"><img src="../images/cart.png" alt="" width="61" height="45" /></a>';?></td>
					    <?php } ?>
					    </tr>
				 </table>
